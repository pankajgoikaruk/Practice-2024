...
class QuadTree: # It is ractangle pluse capacity
    ...
    def insert(self, point):
        ...
        if not self.boundary.containsPoints(point):
            return False
