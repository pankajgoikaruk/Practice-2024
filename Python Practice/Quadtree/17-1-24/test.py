...
ax.invert_yaxis()
plt.tight_layout()
plt.savefig('/workspaces/Practice-2024/Python Practice/Quadtree/17-1-24/img/quadtree2.png')
plt.show()

# Get and print the number of points in each DCR
dcrs = qtree.get_dcrs()
for dcr_name, dcr_df in dcrs.items():
